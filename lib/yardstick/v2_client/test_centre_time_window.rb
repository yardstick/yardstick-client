...
module Yardstick
  module V2Client
    class TestCentreTimeWindow
      ...
      attr_accessor :venue, :venue_id, :attachments, :global_start_datetime, :global_end_datetime, :source_id, :source_type, :time_zone, :proctoring_options, :available_to_apply
